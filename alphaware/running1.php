...
<div id="container">
	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				<li><a href="product1.php">Nike</a></li>
				<li>|</li>
				<li><a href="football1.php">Tommy HilFiger</a></li>
				<li>|</li>
				<li><a href="running1.php" class="active" style="color:#111;">Jockey</a></li>
			</ul>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Luga Pasal Inc. 2015</p>
		</div>
			
			<!-- <div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/Luga Pasal"><li>Facebook</li></a>
						<a href="http://www.twitter.com/Luga Pasal"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/Luga Pasal"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/Luga Pasal"><li>Tumblr</li></a>
					</ul>
			</div> -->
	</div>
</body>
