...
<div id="container">
	...
	<legend>About Us</legend>
		<div id="content">
			<legend><h3>Mission</h3></legend>
					<h4 style="text-indent:60px;">To provide a high quality wear that suit the everyone's style and to be one of the leading wear apparel in the country.</h4>
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Luga pasal the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Luga Pasal 2022</p>
		</div>
