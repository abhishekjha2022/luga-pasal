...
<body>
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Nike</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Tommy HilFiger</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Jockey</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Nike</h2></center></div>
			<br />
